...
|---|---|---|---|
| `v0-boundary-drift` | `v0` | 2026-07-27T09:41 | claims=30, coverage_records=7, drift_records=2, evidence=35, findings=5, observed_repositories=7, partial_failures=0, pins=7 |
| `v1-census` | `v1` | 2026-07-27T09:40 | coverage_records=14, error_nodes=0, evidence=60, findings=16, observed_nodes=14, ok_nodes=12, pins=14, stale_nodes=2, staleness_threshold_days=60 |
| `v2-consumption` | `v2` | 2026-07-27T09:41 | coverage_records=13, cycle=2, finding_references=0, observed_repositories=13, partial_failures=0, pins=13, repo_references=4, total_consumption_records=4 |
