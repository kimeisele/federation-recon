...
**Composed:** 2026-08-12T03:07:18Z
**Procedures:** 5 (see digest/ for per-procedure details)
...
|---|---|---|---|
| `node-census-v1` | `v1` | 2026-08-12T03:06 | - |
| `federation-intelligence-v0` | `1` | 2026-08-08T16:57 | blob_entries=728, contract_candidates=7, declared_relations=1, dependency_candidates=3, entrypoint_candidates=2, findings=0, observed_nodes=3, pins=3, semantic_checks=1, tree_entries=797 |
| `v0-boundary-drift` | `v0` | 2026-08-12T03:06 | claims=30, coverage_records=7, drift_records=2, evidence=35, findings=5, observed_repositories=7, partial_failures=0, pins=7 |
| `v1-census` | `v1` | 2026-08-12T03:06 | coverage_records=7, error_nodes=0, evidence=81, findings=51, observed_nodes=7, ok_nodes=6, pins=7, stale_nodes=1, staleness_threshold_days=60 |
| `v2-consumption` | `v2` | 2026-08-12T03:07 | coverage_records=6, cycle=12, finding_references=0, observed_repositories=6, partial_failures=0, pins=6, repo_references=0, total_consumption_records=0 |
...
- [`federation-intelligence-v0`](digest/federation-intelligence-v0.json)
