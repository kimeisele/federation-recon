...
|---|---|---|---|
| `node-census-v1` | `v1` | 2026-08-19T02:05 | - |
| `v0-boundary-drift` | `v0` | 2026-08-19T02:05 | claims=30, coverage_records=7, drift_records=2, evidence=38, findings=5, observed_repositories=7, partial_failures=0, pins=7 |
| `v1-census` | `v1` | 2026-08-19T02:05 | coverage_records=7, error_nodes=0, evidence=117, findings=54, observed_nodes=7, ok_nodes=6, pins=7, stale_nodes=1, staleness_threshold_days=60 |
| `v2-consumption` | `v2` | 2026-08-19T02:06 | coverage_records=6, cycle=12, finding_references=0, observed_repositories=6, partial_failures=0, pins=6, repo_references=0, total_consumption_records=0 |
