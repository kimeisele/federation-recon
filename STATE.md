...
|---|---|---|---|
| `v0-boundary-drift` | `v0` | 2026-07-24T00:59 | claims=30, coverage_records=21, drift_records=0, evidence=77, findings=19, observed_repositories=7, partial_failures=0, pins=0 |
| `v1-census` | `v1` | 2026-07-23T18:52 | coverage_records=21, error_nodes=0, evidence=77, findings=19, observed_nodes=14, ok_nodes=12, pins=0, stale_nodes=2, staleness_threshold_days=60 |
