...
| `v0-boundary-drift` | `v0` | 2026-08-02T04:07 | claims=30, coverage_records=7, drift_records=2, evidence=38, findings=5, observed_repositories=7, partial_failures=0, pins=7 |
| `v1-census` | `v1` | 2026-08-02T04:06 | coverage_records=7, error_nodes=0, evidence=33, findings=7, observed_nodes=7, ok_nodes=6, pins=7, stale_nodes=1, staleness_threshold_days=60 |
