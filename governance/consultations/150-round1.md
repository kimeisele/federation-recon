...
This round judged the diff **before** the corrections. It is kept whole and
unedited because its central finding — that §5.1 asserted an extraction the
owner had declined — is the reason this PR exists in its present form. The
verdict below is superseded by round 2 (`150.md`), not withdrawn.
